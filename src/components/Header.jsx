...
function Header() {
    const [brandName,setBrandName]=useState("Vijaykumar Mali");
...
{/*                 
            ...
            <div>
                {/* buttons */}
                <a href={actionButton.link} className="bg-orange-600 text-white px-4 py-2 shadow rounded-full">{actionButton.title}</a>
            </div>
